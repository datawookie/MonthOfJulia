...
#
ci(t2, tail = :both)			# Two-sided confidence interval by default
ci(t2, tail = :left)			# One-sided confidence interval (left)
ci(t2, 0.01, tail = :right)		# One-sided confidence interval (right)
